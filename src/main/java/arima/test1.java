...
public class test1 {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            ino = new Scanner(new File(System.getProperty("user.dir") + "/src/main/resources/data/ceshidata.txt"));
            while (ino.hasNext()) {
            ...
            System.out.println("Predict error=" + (arima.aftDeal(arima.predictValue(model[0], model[1]))
                        - arraylist.get(arraylist.size() - 1)) / arraylist.get(arraylist.size() - 1) * 100 + "%");
